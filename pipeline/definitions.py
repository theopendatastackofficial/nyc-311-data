...
from pipeline.assets.ingestion import threeoneone_assets #Our ingestion assets
...
defs = Definitions(
    assets=threeoneone_assets + duckdb_warehouse + [dbt_project_assets],  # Include all MTA and DBT assets
    resources=resources
)